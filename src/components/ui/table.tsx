...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
    return (
        <th
            ...
            className={cn(
                'text-foreground h-10 px-2 text-left text-xs lg:text-sm align-middle font-medium whitespace-nowrap' +
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
    return (
        <td
            ...
            className={cn(
                'p-2 align-middle whitespace-nowrap text-xs lg:text-sm [&:has([role=checkbox])]:pr-0' +
