...
export const vi: TranslationsStructure = {
    common: {
        ...
        over20: 'Trên 20%',
        lowToHight: 'Thấp Nhất',
        hightToLow: 'Cao Nhất',
        lessThanManual: 'Ít hơn giao dịch thủ công',
        moreThanManual: 'Nhiều hơn giao dịch thủ công',
...
là qua đêm). Nó phản ánh chi phí vay vốn và chênh lệch lãi suất giữa các tài sản.<br/><ul>
    ...
    consultationRequest: {
        ...
        contactMethod: {
            prompt: 'Bạn muốn chúng tôi liên hệ bằng cách nào?',
            email: 'Email',
            phone: 'Điện thoại',
    ...
    sidebar: {
        ...
        brandGoal: 'Quản Lý Rủi Ro Của Bạn',
    },
    bookConsultation: {
    ...
    disclaimer: {
        ...
        conclusion:
            '<strong>Bằng việc tiếp tục truy cập website này, bạn đồng ý rằng các thông tin được cung cấp' +
